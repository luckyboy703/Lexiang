...
<%
 ...
 // su.save("D:\\Program Files\\Apache Software Foundation\\Tomcat 8.0\\webapps\\Lexiang\\upload\\transact\\");
 ...
 File file = su.getFiles().getFile(0);
  ...
  file.saveAs("D:\\Program Files\\Apache Software Foundation\\Tomcat 8.0\\webapps\\Lexiang\\upload\\transact\\" + user.getId() + "-" + file.getFileName());
  
  session.setAttribute("filename", file.getFileName());

  // 另存到以WEB应用程序的根目录为文件根目录的目录下

  // file.saveAs("D:\\Lexiang\\upload\\transact\\" + file.getFileName(), su.SAVE_VIRTUAL);

  // 另存到操作系统的根目录为文件根目录的目录下

  // file.saveAs("D:\\temp\\" + file.getFileName(), su.SAVE_PHYSICAL);
