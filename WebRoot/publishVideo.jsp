        ...
        <div class="col1">
            <div class="contact">
                <div class="getintouch">
                	<h3 class="colr">发布视频</h3>
                	<%
                	session.setAttribute("filename", "");
                	%>
                	<form id="form0" name="form0" method="post" action="service/do_upload_video.jsp" enctype="multipart/form-data">
                	<font size="4">添加视频</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              	    <label for="fileField"></label>
              	    <input type="file" name="fileField" id="fileField" />
              	    <input class="buttonone" type="submit" name="upload" id="upload" value="上传"/>
              	    <p>&nbsp;</p>
              	    </form>
                	<form id="form1" name="form1" method="post" action="service/publish_video.jsp">
