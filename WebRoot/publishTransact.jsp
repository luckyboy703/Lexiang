        ...
        <div class="col1">
            <div class="contact">
                <div class="getintouch">
                	<h3 class="colr">发布交易</h3>
                	<%
                	session.setAttribute("filename", "");
                	%>
                	<form id="form0" name="form0" method="post" action="service/do_upload_transact.jsp" enctype="multipart/form-data">
                	<font size="4">物品照片</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              	    <label for="fileField"></label>
              	    <input type="file" name="fileField" id="fileField" />	
              	    <input class="buttonone" type="submit" name="upload" id="upload" value="上传"/>
                	<p>&nbsp;</p>
                	</form>
                	<form id="form1" name="form1" method="post" action="service/publish_transact.jsp">
                	  <font size="4">发&nbsp;布&nbsp;人</font> &nbsp;： 
               	      <input name="radio" type="radio" id="radio" value="radio" />
                	  <label for="radio"><font size="4">个人</font></label>
               	      <input type="radio" name="radio" id="radio2" value="radio2" />
               	      <label for="radio2"><font size="4">商家</font></label>
                	<p>&nbsp;</p>
