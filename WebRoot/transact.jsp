        ...
        <div class="navigation">
        	<div id="smoothmenu1" class="ddsmoothmenu">
                <ul>
                    ...
                    <li><a href="transact.jsp" class=" jiaoyi">交易</a>
                     	<% 	
				    	if(user.getName()!=""&&!user.getName().isEmpty()) { 
				    	%>
                    	<ul>
    ...
    <div id="content_sec">
                ...
                <ul class="bloglisting">
                	...
                	<li>
                        ...
                        <div class="desc">
                            ...
                            <div class="clear"></div>
                            <p class="txt">
                            	<%=transactList.get(i).getContent(50) %>
                            </p>
                            <a href="detailOfArticle&Transact.jsp?type=transact&title=<%=transactList.get(i).getTitle() %>" class="colr readmore">了解更多</a>
                        </div>
                    </li>
                    <%} %>
                </ul>
        ...
        <div class="col2">
            ...
            <div class="categories">
            	<h5>热门分类</h5>
                <%
            	T_RelationDao typeRankDao = new T_RelationDao();
